...
const WhatsAppButton = () => {
  const handleWhatsAppClick = () => {
    const phoneNumber = '923070006185';
    const message = 'Hi%20Vertex%20AI%20Tech%2C%20I%20am%20interested%20in%20your%20services.';
    ...
    if (isMobile) {
      ...
      // Fallback to wa.me if WhatsApp app doesn't open
      setTimeout(() => {
